...
export const useCategoryActions = (language: "en" | "sr", categories: Category[]) => {
    ...
    const confirmCategoryToggle = () => {
        ...
        CategoryService.update(category.id, { isActive: action === "activate" });
        toast({
            title:
                action === "deactivate"
                    ? language === "en"
    ...
    const confirmSubcategoryToggle = () => {
        ...
        CategoryService.update(category.id, { subcategories: updatedSubcategories });
        toast({
            title:
                action === "deactivate"
                    ? language === "en"
