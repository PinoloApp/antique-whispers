                ...
                <CollapsibleTrigger asChild>
                    <div className="p-4 cursor-pointer hover:bg-muted/30 transition-colors">
                        <div className="flex items-start justify-between mb-3">
                            ...
                            <Badge
                                className={`ml-2 shrink-0 flex items-center gap-1 ${auction.status === "active"
                        ...
                        <div className="grid grid-cols-2 xs:grid-cols-4 gap-2 text-sm mb-4 ml-6">
                            <div>
                            ...
                            <div>
                                ...
                                <div className="text-foreground font-medium">{totalBids}</div>
                            </div>
                        </div>
                    </div>
                </CollapsibleTrigger>
