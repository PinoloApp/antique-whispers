...
const CarouselDots = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
    ...
    return (
      <div ref={ref} className={cn("flex justify-center gap-2 pt-3", className)} {...props}>
        {scrollSnaps.map((_, index) => (
          <button
            ...
            className={cn(
              ...
              index === selectedIndex ? "w-6 bg-primary" : "w-2 bg-muted-foreground/30 hover:bg-muted-foreground/50"
            )}
