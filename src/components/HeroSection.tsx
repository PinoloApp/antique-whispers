...
const HeroSection = ({ nextAuctionDate, auctions, selectedAuctionId, onSelectAuction, loading }: HeroSectionProps) => {
  ...
  if (loading) {
    ...
    return (
      <section className="relative min-h-[85vh] flex justify-center bg-gradient-to-b from-primary/5 to-background overflow-hidden pt-20">
        {/* Decorative Elements */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center flex flex-col items-center justify-center min-h-[60vh]">
            ...
            {/* Subtitle */}
            <p className="text-lg sm:text-xl text-muted-foreground mb-10 max-w-xl mx-auto animate-fade-in" style={{ animationDelay: "0.2s" }}>
              {language === "en"
            ...
            {/* Info cards */}
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-6 w-full max-w-3xl animate-fade-in" style={{ animationDelay: "0.4s" }}>
  ...
  return (
    <section
      className={`relative min-h-[85vh] flex justify-center bg-gradient-to-b ${config.gradientClass} overflow-hidden pt-20 transition-all duration-500`}
    >
      {/* Decorative Elements */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-10 w-72 h-72 bg-gold/5 rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Subtitle */}
          <p
            className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto animate-fade-in transition-all duration-300"
          ...
          <div className="flex justify-center mb-10 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            {config.showCountdown ? (
              ...
              <div
                className={`px-6 py-4 rounded-lg border ${currentStatus === "completed"
